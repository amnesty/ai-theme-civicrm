...
<?php if( (!empty($socixs_form_list_mobile) && in_array($node->nid, $socixs_form_list_mobile))
        || (in_array($node->nid, $donativos_form_list_mobile) || in_array($node->nid, $donativos_gracias_list_mobile)) && $mobile){ ?>
