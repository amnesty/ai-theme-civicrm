            ...
            <?php } ?>
                ...
                <div class="box-es-right">
                        ...
                        <div class="three-column formas-pago">
                            ...
                            <p>Si tienes algún problema al realizar tu donación o quieres información sobre otras formas de pago o sobre cuotas reducidas, llámanos a <b>913101277</b> (extensiones <b>30</b> y <b>37</b>) o escribe a <a href="mailto:socios@es.amnesty.org" title="socios@es.amnesty.org">socios@es.amnesty.org</a><br/><br/><br/><br/></p>
                        </div>
                        <div class="three-column compromiso">
                            ...
                            <p>El 100% de nuestros recursos los destinamos a luchar por los derechos humanos en todo el mundo. Nuestras cuentas son públicas y puedes verlas en nuestra web.<br/><br/><br/><br/><br/></p>
                        </div>
                </div><!-- /box-es-right -->
                <?php } ?>
