...
?>
  ...
  <?php if ( /*$node->nid==$socixs_form ||*/
    $node->nid==$socixs_form_cat || $node->nid==$socixs_gracias || $node->nid==$socixs_gracias_A || $node->nid==$socixs_gracias_B ||
    $node->nid==$socixs_gracies || $node->nid==$socixs_form_A || $node->nid==$socixs_form_B ){ ?>
